#I watched a youtube video on making code readable, and it said you need 8 space indents! So I'll be using 8 space indents from now on!!!
...
for i in range((len(roads_string))//2):
        ...
        tiles["S1"]["roads"].append(quick_reorder(road))
    
print(tiles["S1"]["roads"])
